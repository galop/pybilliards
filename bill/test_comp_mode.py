...
class TestMyGame(unittest.TestCase):
    ...
    #             x1 = random.randint(x-200, x+200)
    #             y1 = random.randint(y-200, y+200)
    ...
    # def test_balls_collision_other_loc(self):
    #     # self.assertEqual(type(create_rand_Ball(20)), game.Balls)
    #     # x = game.create_rand_Ball(20)
    #     x, y        = dispWidth/2, dispHeight/2
    #     print x, y
    ...
    #         x1 = x + int(radius*sin(theta))
    #         y1 = y - int(radius*cos(theta))
            
    #         white_ball  = Balls((x1, y1),color = (255, 255, 255))
    #         white_ball.disp()
    #         # Now I will strike the two balls and see where they go
            
    #         white_ball.angle = pi + theta 
    #         # This is angle for white_ball to come :D
